...
export default function AgentGraphVisualization() {
  return (
    <section className="relative py-24 md:py-32 border-t border-[var(--color-border)] overflow-hidden">
      <AgentNetwork />
      <Container className="relative z-10">
        <div className="text-center mb-16">
          <SectionLabel label="Multi-Agent" index="04" className="justify-center" />
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 600 500" fill="none">
            {/* Flowing data lines between agents */}
            <motion.path
              d="M300 60 L300 130"
          ...
          <div className="relative flex flex-col items-center gap-4">
            {agents.map((agent, i) => (
              ...
              >
                <div className="flex items-center gap-4 p-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-1)] hover:border-[var(--color-border-strong)] transition-all duration-300 group">
                  {/* Pulse dot */}
                  <motion.div
